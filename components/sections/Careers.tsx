      ...
      <div className="container-max relative z-10 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
        ...
        <div>
          <SectionHeading
            ...
            description="We're always looking for talented, energetic people to join the largest premium nightclub in the Caucasus. Send your CV and our team will get back to you."
          />
            ...
            <div>
              ...
              <a
                href={`mailto:${careersEmail}?subject=${encodeURIComponent(
                  "Job Application — Extra Baku"
                )}`}
                className="font-heading text-base font-semibold text-gold-light underline-offset-4 hover:underline"
              >
                {careersEmail}
              </a>
            </div>
            ...
            {sent ? (
              ...
              >
                ...
                <p className="mt-3 max-w-sm font-general text-white/60">
                  ...
                  {careersEmail}. Just attach your CV and hit send — we&apos;ll
                  take it from there.
                </p>
                <button
                  onClick={reset}
              ...
              >
                ...
                <p className="text-center font-general text-xs text-white/40">
                  Opens your email app to {careersEmail} — attach your CV and
                  send.
                </p>
              </motion.form>
            )}
